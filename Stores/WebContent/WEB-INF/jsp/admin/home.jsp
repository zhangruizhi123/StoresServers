...
<div class="easyui-layout" id="layout" style="width:1000px;;height:500px;">
		<div region="west" split="true" title="网上购书系统" style="width:200px;">
			<ul class="nav">
				<li url="${ctx}/admin/system/index">系统管理</li>
				<li url="${ctx}/admin/book/index">书籍管理</li>
				<li url="${ctx}/admin/user/index">用户管理</li>
				<li url="${ctx}/admin/type/index">类型管理</li>
				<li url="${ctx}/admin/first/index">首页显示管理</li>
				<li url="${ctx}/admin/userBook/index">订单管理</li>
				
			</ul>
		</div>
		<div id="content" region="center" title="操作" style="padding:5px;">
			<div id="tabs" class="easyui-tabs" style="width:100%;height:100%;">
				<div title="Home" url="${ctx}/book/index">
				 	图书售卖系统
				</div>
			</div>
